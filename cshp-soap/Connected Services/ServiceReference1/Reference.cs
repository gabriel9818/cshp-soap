...
namespace ServiceReference1
{
    ...
    public interface ISoapService
    {
        ...
        // CODEGEN: Se está generando un contrato de mensaje, ya que el nombre de elemento SumResult del espacio de nombres http://tempuri.org/ no está marcado para convertirse en valor nulo
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/ISoapService/Sum", ReplyAction="*")]
        ServiceReference1.SumResponse Sum(ServiceReference1.SumRequest request);
    ...
    public partial class SoapServiceClient : System.ServiceModel.ClientBase<ServiceReference1.ISoapService>, ServiceReference1.ISoapService
    {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        ServiceReference1.SumResponse ServiceReference1.ISoapService.Sum(ServiceReference1.SumRequest request)
        {
        ...
        public string Sum(int num1, int num2)
        {
            ...
            ServiceReference1.SumResponse retVal = ((ServiceReference1.ISoapService)(this)).Sum(inValue);
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_ISoapService_soap))
            {
                return new System.ServiceModel.EndpointAddress("http://localhost:5007/Service.asmx");
            }
            throw new System.InvalidOperationException(string.Format("No se pudo encontrar un punto de conexión con el nombre \"{0}\".", endpointConfiguration));
        }
